...
def main():
    ...
    # ---- TRAIN LOADER(S) ----
        if use_ipmix_now and args.pair_batches:
            ...
            # Single-stream IPMix (your original path: tuples (clean, aug1, aug2) if --no_jsd not set)
            loader_train = torch.utils.data.DataLoader(
