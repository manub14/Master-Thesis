...
parser.add_argument(
    ...
    type=str,
    default=None,
    help='Post-encoding hole-fill mode: "spatial", "spatiotemporal" (or "3d"), or None',
)
...
def main():
    ...
    model = create_model(
        ...
        TET=args.TET,
        postenc_holefill_mode=args.postenc_holefill_mode,
        postenc_holefill_prob=args.postenc_holefill_prob,
    )
